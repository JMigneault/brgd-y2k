...
public class GameOverMenu : MonoBehaviour
{
    ...
    public void Restart()
    {
        ...
        SceneManager.LoadScene("tsMainScene");
    }
    ...
    public void MainMenu()
    {
        ...
        SceneManager.LoadScene("tsStartMenuScene");
    ...
    {
        //Go to credits scene
        SceneManager.LoadScene("tsCreditsScene");
    }

    public void Leaderboard()
    {
        //Go to the leaderboard scene
        SceneManager.LoadScene("tsLeaderboardScene");
    }
